...
[![GitHub commits since tagged version](https://img.shields.io/github/commits-since/kevinzg/facebook-scraper/v0.2.39)](https://github.com/kevinzg/facebook-scraper/commits/)
...
```sh
pip install https://github.com/kevinzg/facebook-scraper/archive/refs/heads/master.zip
```
